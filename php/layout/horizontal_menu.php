<nav id="content_nav">
	<a href="./homepage.php"><img class= "immaginisezione" border="0" alt="home" src="./../immagini/home.png" width="100" height="100"></a>	
	...
	<a href="javascript:show('search')"><img class= "immaginisezione" border="0" alt="ricerca" src="./../immagini/lente.png" width="100" height="100"></a>	
	<aside id="search">
